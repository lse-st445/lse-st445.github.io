...
This course will cover the principles of digital methods for storing and structuring data, including data types, relational and non-relational database design, and query languages. Using NumPy and Pandas the course will also cover workflow management for typical data transformation and cleaning projects, frequently the starting point and most time-consuming part of any data science project. Students will learn to build, populate, manipulate and query databases based on datasets relevant to their fields of interest. This course uses a project-based learning approach and group-based collaboration, essential ingredients of modern data science projects. The coverage of data sharing will include key skills in on-line publishing, as well as the use of revision-control and group collaboration tools such as GitHub. Each student will use GitHub for accessing and submitting course materials and assignments.
...
After Reading Week we will launch into Exploratory Data Analysis (EDA) and use the power of matplotlib and Seaborn to visualise a dataset in many different ways. We will then cover a variety of methods for observing patterns in data using clustering and dimensional reduction. The features we will extract can be either linear or non-linear. You will learn how to evaluate the performance of classification models and build and visualise graphical network models. 
